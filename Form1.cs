    ...
    public partial class Form1 : Form
    {
        ...
        public Form1()
        {
            ...
            products = new Product[]
            {
                ...
                new Product { Name = "Картошка-фри", Price = 30 },
                new Product { Name = "Кока-кола", Price = 14 }
            };
        ...
        private void PayButton_Click(object? sender, EventArgs e)
        {
            Task.Run(async () =>
            {
                ...
                var dialogResult = MessageBox.Show("Очистить все поля сейчас?", "Очистка", MessageBoxButtons.YesNo);
